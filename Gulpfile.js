...
gulp.task( 'js_plugin', function ( done ) {
    app.processJS({
        'name'       : 'plugin js',
        'inputFiles' : [ dir.input.js+'/edt.js' ],
        'outputDir'  : dir.output.js,
        'outputFile' : 'edt.min.js',
    });
    done();
});
...
gulp.task( 'less_plugin', function ( done ) {
    app.processLess({
        'name'       : 'plugin less',
        'inputFiles' : [ dir.input.less+'/edt.less' ],
        'outputDir'  : dir.output.less,
        'outputFile' : 'edt.min.css',
    });
    done();
});
...
gulp.task( 'watch', function () {
    ...
    livereload.listen();
    // JavaScript
    // gulp.watch( dir.input.js+'/edt.js', gulp.parallel( 'js_plugin' ) );
    // Less
    gulp.watch( dir.input.less+'/**/*.less', gulp.parallel( 'less_plugin' ) );
    // notify
